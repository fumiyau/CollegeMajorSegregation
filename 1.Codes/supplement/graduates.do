...
forvalues i = 1/4{
	...
	graph export 3.Results/supplement/graduates/`opt_title`i''.pdf,replace 
}
...
rename score scorem
save "2.Data/dtafiles/supplement/graduates/ContMajor.dta",replace
...
**Merge datasets
merge 1:1 year type using "2.Data/dtafiles/supplement/graduates/ContMajor.dta"
...
graph export "3.Results/supplement/graduates/Fig1_1.pdf",replace 
...
save "2.Data/dtafiles/supplement/graduates/ContStem.dta",replace
...
save "2.Data/dtafiles/supplement/graduates/ContNonStem.dta",replace
...
save "2.Data/dtafiles/supplement/graduates/ContHealth.dta",replace

merge 1:1 year type using "2.Data/dtafiles/supplement/graduates/ContStem.dta"
drop _merge
merge 1:1 year type using "2.Data/dtafiles/supplement/graduates/ContNonStem.dta"
...
graph export "3.Results/supplement/graduates/Fig1_1_stemx.pdf",replace 
...
, xtick(1975(5)2020, grid) xlabel(1975(15)2020) ylabel(0(10)100) ///
scheme(plotplain) xtitle("Year") legend(row(1) pos(6))
graph export "3.Results/supplement/graduates/Fig1_1_stem.pdf",replace 
...
graph export "3.Results/supplement/graduates/Fig1_1a.pdf",replace 
...
save "2.Data/dtafiles/supplement/graduates/Decomp.dta",replace

use "2.Data/dtafiles/supplement/graduates/Decomp.dta",clear
keep if stem == 1
rename comp2 comp2st
rename comp1 comp1st
save "2.Data/dtafiles/supplement/graduates/DecompStem.dta",replace

use "2.Data/dtafiles/supplement/graduates/Decomp.dta",clear
keep if stem == 0
rename comp2 comp2ns
rename comp1 comp1ns
save "2.Data/dtafiles/supplement/graduates/DecompNonStem.dta",replace

use "2.Data/dtafiles/supplement/graduates/Decomp.dta",clear
keep if stem == 2
rename comp2 comp2hl
rename comp1 comp1hl
save "2.Data/dtafiles/supplement/graduates/DecompNonHealth.dta",replace

merge 1:1 year using "2.Data/dtafiles/supplement/graduates/DecompStem.dta"
drop _merge
merge 1:1 year using "2.Data/dtafiles/supplement/graduates/DecompNonStem.dta"
* Figure
...
graph export 3.Results/supplement/graduates/Decomp`i'.pdf, replace
