...
rename score scorem
save "2.Data/dtafiles/supplement/excl_others/ContMajor.dta",replace
...
**Merge datasets
merge 1:1 year type using "2.Data/dtafiles/supplement/excl_others/ContMajor.dta"
...
graph export "3.Results/supplement/excl_others/Fig1_1.pdf",replace 
...
save "2.Data/dtafiles/supplement/excl_others/ContStem.dta",replace
...
save "2.Data/dtafiles/supplement/excl_others/ContNonStem.dta",replace
...
save "2.Data/dtafiles/supplement/excl_others/ContHealth.dta",replace

merge 1:1 year type using "2.Data/dtafiles/supplement/excl_others/ContStem.dta"
drop _merge
merge 1:1 year type using "2.Data/dtafiles/supplement/excl_others/ContNonStem.dta"
...
graph export "3.Results/supplement/excl_others/Fig1_1_stemx.pdf",replace 
...
save "2.Data/dtafiles/supplement/Decomp.dta",replace

use "2.Data/dtafiles/supplement/Decomp.dta",clear
keep if stem == 1
rename comp2 comp2st
rename comp1 comp1st
save "2.Data/dtafiles/supplement/DecompStem.dta",replace

use "2.Data/dtafiles/supplement/Decomp.dta",clear
keep if stem == 0
rename comp2 comp2ns
rename comp1 comp1ns
save "2.Data/dtafiles/supplement/DecompNonStem.dta",replace

use "2.Data/dtafiles/supplement/Decomp.dta",clear
keep if stem == 2
rename comp2 comp2hl
rename comp1 comp1hl
save "2.Data/dtafiles/supplement/DecompNonHealth.dta",replace

merge 1:1 year using 2.Data/dtafiles/supplement/DecompStem.dta
drop _merge
merge 1:1 year using 2.Data/dtafiles/supplement/DecompNonStem.dta
* Figure
...
graph export 3.Results/supplement/Decomp`i'.pdf, replace
